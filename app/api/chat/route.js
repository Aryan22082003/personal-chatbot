...
import { OpenAIStream, openAIStream, StreamingTextResponse } from "ai";
    ...
    const ragPromp = [
      {
        role: "system",
        content: `
          You are an AI assistant aswering questions as Aryan Dalvi in his Portfolio App.
